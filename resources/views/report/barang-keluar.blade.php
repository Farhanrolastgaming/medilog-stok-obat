...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
    <form method="GET" action="{{ route('laporan.barang-keluar') }}" class="grid grid-cols-3 gap-4 mb-4">
        <div>
                ...
                <tbody>
                    ...
                    @forelse ($transaksis as $transaksi)
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="py-4 px-4 border-r border-gray-200">{{ abs($detail->jumlah_masuk) }}</td>
                    ...
                    <tr>
                        <td colspan="6" class="py-8 px-4 text-center text-gray-500">
                            ...
                            <p>Data barang keluar tidak ada</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
